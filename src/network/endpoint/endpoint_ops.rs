...
use super::EndPoint;
use super::classify::{
    classify_by_port, classify_by_services, is_appliance_hostname, is_appliance_mac,
    is_computer_by_ports, is_gaming_hostname, is_gaming_mac, is_gateway_mac, is_lg_appliance,
    is_phone_hostname, is_phone_mac, is_printer_hostname, is_soundbar_hostname, is_soundbar_model,
    is_tv_hostname, is_tv_mac, is_tv_model, is_vm_hostname,
};
use super::constants::{
...
impl EndPoint {
    ...
    // =========================================================================
    // Gateway / network-level classification (moved from gateway.rs)
    // =========================================================================
